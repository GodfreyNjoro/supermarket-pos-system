...
/* harmony import */ var _home_ubuntu_supermarket_pos_system_nextjs_space_app_api_products_route_ts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./app/api/products/route.ts */ "(rsc)/./app/api/products/route.ts");
...
const routeModule = new next_dist_server_future_route_modules_app_route_module_compiled__WEBPACK_IMPORTED_MODULE_0__.AppRouteRouteModule({
    ...
    resolvedPagePath: "/home/ubuntu/supermarket_pos_system/nextjs_space/app/api/products/route.ts",
    nextConfigOutput,
    userland: _home_ubuntu_supermarket_pos_system_nextjs_space_app_api_products_route_ts__WEBPACK_IMPORTED_MODULE_3__
});
...
async function GET(request) {
    try {
        ...
        if (lowStock === "true") {
            where.stock = {
                lte: _lib_db__WEBPACK_IMPORTED_MODULE_1__.prisma.product.fields.reorderLevel
            };
        }
...
async function POST(request) {
    try {
        ...
        const { barcode, name, description, price, stock, reorderLevel, categoryId, storeId, imageUrl, cloud_storage_path, isPublic } = body;
        ...
        const existingProduct = await _lib_db__WEBPACK_IMPORTED_MODULE_1__.prisma.product.findFirst({
            where: {
                barcode,
                storeId
            }
