...
/* harmony import */ var _home_ubuntu_supermarket_pos_system_nextjs_space_app_api_customers_route_ts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./app/api/customers/route.ts */ "(rsc)/./app/api/customers/route.ts");
...
const routeModule = new next_dist_server_future_route_modules_app_route_module_compiled__WEBPACK_IMPORTED_MODULE_0__.AppRouteRouteModule({
    ...
    resolvedPagePath: "/home/ubuntu/supermarket_pos_system/nextjs_space/app/api/customers/route.ts",
    nextConfigOutput,
    userland: _home_ubuntu_supermarket_pos_system_nextjs_space_app_api_customers_route_ts__WEBPACK_IMPORTED_MODULE_3__
});
...
/* harmony import */ var next_auth__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! next-auth */ "(rsc)/../../../../opt/hostedapp/node/root/app/node_modules/next-auth/index.js");
...
async function GET(request) {
    try {
        ...
        const customers = await _lib_db__WEBPACK_IMPORTED_MODULE_1__.prisma.customer.findMany({
            where,
            include: {
                _count: {
                    select: {
...
async function POST(request) {
    try {
        ...
        if (phone) {
            const existingPhone = await _lib_db__WEBPACK_IMPORTED_MODULE_1__.prisma.customer.findUnique({
                where: {
                    phone
                }
            });
        ...
        if (email) {
            const existingEmail = await _lib_db__WEBPACK_IMPORTED_MODULE_1__.prisma.customer.findUnique({
                where: {
                    email
                }
            });
        ...
        const customer = await _lib_db__WEBPACK_IMPORTED_MODULE_1__.prisma.customer.create({
            data: {
                name,
                phone: phone || null,
                email: email || null
...
/* harmony export */   validateSessionToken: () => (/* binding */ validateSessionToken)
/* harmony export */ });
...
function generateSessionToken() {
    return crypto__WEBPACK_IMPORTED_MODULE_4___default().randomBytes(32).toString("hex");
}
const authOptions = {
